...
public class SimpleTreeNode<T>{
    ...
    public SimpleTreeNode addChild(T data) {
...
return null;
    ...
    public static void main(String[] args) {
        SimpleTreeNode<String> root = new SimpleTreeNode<>("Physics");

        SimpleTreeNode<String> child1 = new SimpleTreeNode<>("Mechanics");
        child1.addChild("Vector");
        child1.addChild("Angular Motion");
        child1.addChild("Work,Power,Energy");
        child1.addChild(new SimpleTreeNode("Hello"));
